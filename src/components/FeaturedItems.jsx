                                ...
                                <div className="thumb">
                                    ...
                                    <div className="hover-effect">
                                        <div className="content">
                                            <h4>
                                                Walk In The Nature <i className="fa fa-star" />
                            ...
                            <div className="item">
                                <div className="thumb">
                                    ...
                                    <div className="hover-effect">
                                        <div className="content">
                                            <h4>
                                                Smile In The Nature <i className="fa fa-star" />
                                                <i className="fa fa-star" />
                                                <i className="fa fa-star" /> <span>(4.5)</span>
                                            </h4>
                                            <ul>
                            ...
                            <div className="item">
                                <div className="thumb">
                                    ...
                                    <div className="hover-effect">
                                        <div className="content">
                                            <h4>
                                                Happy In The Nature <i className="fa fa-star" />
                                                <i className="fa fa-star" />
                                                <i className="fa fa-star" />
                                                <i className="fa fa-star" /> <span>(4.5)</span>
                                            </h4>
                            ...
                            <div className="item">
                                <div className="thumb">
                                    ...
                                    <div className="hover-effect">
                                        <div className="content">
                                            <h4>
                                                Run In The Nature <i className="fa fa-star" />
                                                <i className="fa fa-star" />
                                                <i className="fa fa-star" />
                                                <i className="fa fa-star" /> <span>(4.5)</span>
                                            </h4>
                                            <ul>
                                                ...
                                                <li>
                                                    <span>Awards:</span> $5,500 + Canon EOS R3
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div className="item">
                                <div className="thumb">
                                    ...
                                    <div className="hover-effect">
                                        <div className="content">
                                            <h4>
                                                Stay In The Nature <i className="fa fa-star" />
                                                <i className="fa fa-star" />
                                                <i className="fa fa-star" /> <span>(4.5)</span>
                                            </h4>
                                            <ul>
                                                ...
                                                <li>
                                                    <span>Awards:</span> $4,400 + Canon EOS R5
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div className="hover-effect">
                                        <div className="content">
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    <span>Awards:</span> $3,800 + Canon EOS R6
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div className="item">
                                <div className="thumb">
                                    ...
                                    <div className="hover-effect">
                                        <div className="content">
                                            <h4>
                                                Shoot In The Nature <i className="fa fa-star" />
                                                <i className="fa fa-star" />
                                                <i className="fa fa-star" /> <span>(4.5)</span>
                                            </h4>
                                            <ul>
                                                ...
                                                <li>
                                                    <span>Awards:</span> $2,400 + Canon EOS R7
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div className="item">
                                <div className="thumb">
                                    ...
                                    <div className="hover-effect">
                                        <div className="content">
                                            <h4>
                                                Fly In The Nature <i className="fa fa-star" />
                                                <i className="fa fa-star" />
                                                <i className="fa fa-star" /> <span>(4.5)</span>
                                            </h4>
                                            <ul>
